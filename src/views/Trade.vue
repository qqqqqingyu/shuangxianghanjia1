      ...
      <el-col :xs="24" :md="24" :lg="12">
        ...
        <el-card class="box-card">
          ...
          <div class="stty_il trade_button" style="text-align: center">
             <el-button class="toggle-btn" size="mini" type="danger" round>买入</el-button>
             <el-button class="toggle-btn" size="mini" plain type="primary" round @click="goToT2(id,title)">卖出</el-button>
        ...
        <div class="hcharts">
          ...
          <el-row class="stty_il">
              <el-col :span="11" :offset="1">
                <el-radio class="radio-pl" v-model="tradeForm.auctionType" label="0" size="large">喊价交易</el-radio>
              </el-col>
              <el-col :span="11" :offset="1">
           ...
           <el-row class="stty_il">
              ...
              <el-col :span="6" class="input-pd" v-if="tradeForm.auctionType==0">
          ...
          <el-row class="stty_il">
            ...
            <el-col :span="22" :offset="1" v-if="tradeForm.auctionType==0">
...
<!--            <el-col :xs="4">交易理由</el-col><br>-->
          ...
          <el-row class="stty_il submit-margin">
            <el-col :offset="1" >
              <el-button size="medium" plain @click="startTransactionMethod" type="danger" round>买入</el-button>
            </el-col>
          </el-row>
...
export default {
  ...
  data() {
    return {
      coin:'',
      share:null,
      getTradeCount:'无', //获取的喊价数量，获取不到则显示无
      getTradePrice:'无', //获取的喊价价格，获取不到则显示无
      timeNow:'', //当前时间
      id:'',
      title:'',
      sellSeq:'', //卖价队列
  ...
  methods : {
    ...
    getCdaActivityTransactionInfoMethod() {
        ...
        if (res.data.code === "200") {
          ...
          //获取喊价数量、喊价价格和id，应该只会获取到一个数量的值和一个价格的值。若不是则加上循环。
          this.getTradeCount = res.data.trade_account.data[0].trade_count
          this.getTradePrice = res.data.trade_account.data[0].trade_price
    ...
    startTransactionMethod() {
      ...
      if(this.tradeForm.inputTradePrice.length==0 && this.tradeForm.auctionType==0){
        alert("未输入交易价格");
        return;
      }
      if(this.tradeForm.inputTradeEndTime.length==0&&this.tradeForm.auctionType==0){
        alert("未输入截止时间");
        return;
      }
      ...
      if(this.tradeForm.auctionType==0){
